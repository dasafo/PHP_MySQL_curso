...
<?php
    ...
    function ejecutaConsulta($labusqueda){
        ...
        $consulta="SELECT * FROM PRODUCTOS WHERE NOMBREARTÍCULO LIKE '%$labusqueda%'"; //realizamos una consulta con SQL para que nos muestre lo que se almacena en busqieda(lo que metemos en la celda de entrada)
