...
<body>
   ...
   <?php
        ...
        $consulta="INSERT INTO PRODUCTOS (CÓDIGOARTÍCULO, SECCIÓN, NOMBREARTÍCULO) VALUES ('AR44', 'DEPORTES', 'RAQUETA BADMINTÓN')"; //realizamos una consulta con SQL para que nos muestre lo que se almacena en busqieda(lo que metemos en la celda de entrada)
